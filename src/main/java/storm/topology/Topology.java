...
public class Topology {
    ...
    public static void main(String[] args) throws Exception {
        ...
        builder.setBolt("available-3h-detector", new Available3Hours().withWindow(new Duration(3, TimeUnit.HOURS), new Duration(5, TimeUnit.MINUTES)), nbExecutors).shuffleGrouping("stations-splitter");
